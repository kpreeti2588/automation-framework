...
//	private By loginGroup = By.xpath(".//*[@id='edit-field-group-promotile']/option[3]");
	...
	private By save = By.xpath(".//*[@id='edit-submit']");
	...
	private By ckEditorText = By.xpath(".//*[contains(@class,'group-content')]/div[1]/h3");
	private By ckEditorText2 = By.xpath(".//*[contains(@class,'group-content')]/div[2]/p");
	...
	private By internalpagesSearch = By.cssSelector("div[class*='menu-manager-pageHolder'] div[class*='menu-manager-pageHolder']:nth-child(1) input[name='pageSearch']");
	private By transactionalpagesSearch = By.cssSelector("div[class*='menu-manager-pageHolder'] div[class*='menu-manager-pageHolder']:nth-child(2) input[name='pageSearch']");
...
//	private By dropLocation = By.cssSelector(".rst__tree > div");
	...
	private By activePublicMenu = By.id("edit-active-public-menu");
	private By activeLoggedInMenu = By.id("edit-active-logged-in-menu");
	...
	public void selectActivePublicMenu(String menuName){
		selectByVisibleText(activePublicMenu, "Select Public Menu", menuName);
	}
	
	public void selectActiveLoggedInMenu(String menuName){
		selectByVisibleText(activeLoggedInMenu, "Select Public Menu", menuName);
	}
	...
	public void login(String username, String password){
		if(username.trim().equalsIgnoreCase("")){
			username = Dictionary.get("USER_NAME").trim();
			password = Dictionary.get("PASS").trim();
		}
	...
	public void clickPageInPageManager(String pageName){
		List<WebElement> Pages= getWebElementsList(pageTable);
		for (int i=1;i<=Pages.size();i++){
			if(getDriver().findElement(By.xpath("//table/tbody/tr["+i+"]/td[3]")).getText().equalsIgnoreCase(pageName)){
				click(getDriver().findElement(By.xpath("//table/tbody/tr["+i+"]/td[3]/..//i[@class='material-icons' and text()='settings']")),"Page Settings");
				break;
			}
		}
	}
...
//		System.out.println(getText(publicThirdPromoTitle));
	...
	public void typeCKEditorText(String ckEditorText){
		WebElement we = getElementWhenVisible(this.ckEditorText);
		we.clear();
	...
	public void typeInternalPagesSearch(String text) throws Exception {
		type(internalpagesSearch, "Internal page search", text);
	}
	
	public void typeTransactionalPagesSearch(String text) throws Exception {
		type(transactionalpagesSearch, "Transactional page search", text);
	}
	
	public void dragAndDropInternalPages(String searchtext) throws Exception {
		if(!searchtext.trim().equalsIgnoreCase(""))
			typeInternalPagesSearch(searchtext);
		String drag = "div[class*='menu-manager-pageHolder'] div[class*='menu-manager-pageHolder']:nth-child(1) div[class*='menu-manager-draggable']:nth-child(2)";
	...
	public void clickHoldnDrop(WebElement drag, WebElement drop1, WebElement drop2){
	...
	public void clickPageSettingsIcon(String pageType) {
		By pageSettingsIcon = By.xpath(".//tr[descendant::td[@headers='view-node-access-level-table-column' and text()='"+pageType+"        ']][1]//i[text()='settings']");
