...
public class DashboardHeader extends BaseUtil {
	...
	private By accountName = By.cssSelector(".react-root-dashboard-header > div > div > div:first-child > h3 > span");
	private By accountId = By.cssSelector(".react-root-dashboard-header > div > div > div:first-child > p:last-child");
	private By totalDue = By.cssSelector(".react-root-dashboard-header > div > div > div:last-child > h3 > span");
...
//	private By client_logo = By.cssSelector(".navbar-brand-logo");
	...
	public boolean waitForDasboardHeader(){
		getElementWhenVisible(dashboardheader);
		return true;
	}
	...
	public void clickAMGRLogout(){
		...
		try {
			getElementWhenPresent(By.xpath(".//input[@name='email'] | .//div[@class='mobile-signin']//span[text()='Sign In']"), 5);
		} catch(Exception ex) {
			// Do Nothing
		}
	}
