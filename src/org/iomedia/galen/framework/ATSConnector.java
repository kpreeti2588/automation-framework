...
public class ATSConnector {
	...
	public String[] getTMInvoiceAPIResponse(String dsn, JSONObject payload, String cookies) throws JSONException, Exception {
	...
	public String waitForTMResponse(String dsn, JSONObject payload) throws JSONException, Exception {
		...
		String cookies = null;
		do{
			String[] allfields = getTMInvoiceAPIResponse(dsn, payload, cookies);
