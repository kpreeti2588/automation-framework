...
public class Util {
	...
	public boolean isProd() {
    	...
    	if(tm_host.contains("am.ticketmaster.com")) {
    		return true;
    	} else {
    		return false;
    	}
	...
	public String getAppUrl() {
    	...
    	if(tm_host.contains("qa1.acctmgr.us-east-1.nonprod-tmaws.io")) {
    		return "https://tm-am-qa.io-media.com";
    	} else if(tm_host.contains("stg1.acctmgr.us-east-1.ppub-tmaws.io")) {
    		return "https://tm-am-stg.io-media.com";
    	} else if(tm_host.contains("oss.ticketmaster.com")) {
